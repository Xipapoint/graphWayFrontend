...
const UiVertex: React.FC<UiVertexProps> = ({shortestVertices, id, xPos, yPos, draggable, updateVertexPosition, pair, handleDeleteVertex, editMode}) => {
